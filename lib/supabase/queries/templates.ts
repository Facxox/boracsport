...
const TEMPLATE_COLUMNS =
  "id, name, mockup_url_front, mockup_url_back, mockup_url_neck, mockup_url_collar, mockup_url_sleeves, mockup_url_cuffs, mockup_url_short, mockup_url_socks, scene_config, editable_zones, default_config, version, price, active, created_at, updated_at" as const
