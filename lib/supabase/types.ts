...
export interface TemplateRow {
  ...
  // Mockups por zona visual (opcionales, nullable). El diseñador 2D no los
  // usa todavía (componer desde TextureCompositor) pero quedan disponibles
  // para futuras mejoras (mockup de fondo + overlays).
